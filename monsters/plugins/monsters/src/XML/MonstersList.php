...
class MonstersList implements \Iterator, \Countable, \ArrayAccess
{
/**
 * Monsters directory.
 *
 ...
 * @version 0.1.3
 * @param string $name Monster name.
 * @return \MyAAC\Plugins\Monsters\XML\Monster Monster data.
 ...
 */
    public function getMonster($name)
    {
        ...
        {
            // loads file
            $monster = new \MyAAC\Plugins\Monsters\XML\Monster();
 ...
 *
 * @return \MyAAC\Plugins\Monsters\XML\Monster Monster.
 * @throws \DOMException On DOM operation error.
 */
 ...
 * @version 0.1.3
 * @param string $offset Array key.
 * @return \MyAAC\Plugins\Monsters\XML\Monster Monster instance.
 * @throws \DOMException On DOM operation error.
 */
	#[\ReturnTypeWillChange]
